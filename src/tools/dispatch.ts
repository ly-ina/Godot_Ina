...
export function getToolDefinitions(): ToolDefinition[] {
  return [
    ...
    },
    {
      ...
      description: "Generate a Stardew Valley-quality pixel-art character sprite as SVG. Compose from body type, hair style, clothing, colors, and accessories.",
      inputSchema: {
        type: "object",
        properties: {
          output_path: { type: "string", description: "Output directory" },
          name: { type: "string", description: "Character name (filename)" },
          body_type: { type: "string", enum: ["human", "child", "muscular", "plump"], description: "Body type" },
          hair: { type: "string", enum: ["short", "long", "twin_tail", "ponytail", "bob", "bald"], description: "Hair style" },
          hair_color: { type: "string", description: "Hair color (hex or name)" },
          skin_color: { type: "string", description: "Skin color" },
          top: { type: "string", enum: ["shirt", "jacket", "vest", "robe", "armor"], description: "Top clothing" },
          top_color: { type: "string", description: "Top color" },
          bottom: { type: "string", enum: ["pants", "skirt", "shorts"], description: "Bottom clothing" },
          bottom_color: { type: "string", description: "Bottom color" },
          shoe_color: { type: "string", description: "Shoe color" },
          eye_color: { type: "string", description: "Eye color" },
          headwear: { type: "string", enum: ["none", "hat", "ribbon", "crown", "glasses"], description: "Headwear" },
          hold: { type: "string", enum: ["none", "sword", "staff", "book", "flower"], description: "Held item" },
          expression: { type: "string", enum: ["neutral", "happy", "angry"], description: "Expression" },
          scale: { type: "number", description: "Pixel scale (default: 3)" },
          help: { type: "boolean", description: "List all options" },
        },
...
export function executeTool(name: string, args: Record<string, unknown> | undefined): ToolResponse {
  ...
  if (name === "generate_sprite") {
    ...
    const opts: GenerateSpriteArgs = {
      ...
      name: args?.name as string | undefined,
      body_type: args?.body_type as "human" | "child" | "muscular" | "plump" | undefined,
      hair: args?.hair as "short" | "long" | "twin_tail" | "ponytail" | "bob" | "bald" | undefined,
      hair_color: args?.hair_color as string | undefined,
      skin_color: args?.skin_color as string | undefined,
      top: args?.top as "shirt" | "jacket" | "vest" | "robe" | "armor" | undefined,
      top_color: args?.top_color as string | undefined,
      bottom: args?.bottom as "pants" | "skirt" | "shorts" | undefined,
      bottom_color: args?.bottom_color as string | undefined,
      shoe_color: args?.shoe_color as string | undefined,
      eye_color: args?.eye_color as string | undefined,
      headwear: args?.headwear as "none" | "hat" | "ribbon" | "crown" | "glasses" | undefined,
      hold: args?.hold as "none" | "sword" | "staff" | "book" | "flower" | undefined,
      expression: args?.expression as "neutral" | "happy" | "angry" | undefined,
